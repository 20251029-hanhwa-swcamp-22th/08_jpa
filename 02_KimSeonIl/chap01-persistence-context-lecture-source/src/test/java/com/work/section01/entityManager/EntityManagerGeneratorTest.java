...
class EntityManagerGeneratorTest {
  ...
  void testGenerateEntityManagerFactory() {
    ...
    assertNotNull(factory); // 엔티티 매너지 팩토리 생성 확인
  }


  @Test
  @DisplayName("엔티티 매니저 팩토리 싱글톤 패턴 확인")
  void testEntityManagerFactorySignleton() {
    //when
    ...
    //then
    assertSame(factory1, factory2);  //두 객체의 참조주소가 같은지 확인
  ...
  void testGenerateEntityManager() {
    //when
    //팩토리 객체를 통해 새로운 EntityManager 객체를 생성
