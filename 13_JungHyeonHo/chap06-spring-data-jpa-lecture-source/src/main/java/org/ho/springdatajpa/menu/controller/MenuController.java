...
import org.ho.springdatajpa.common.Pagination;
import org.ho.springdatajpa.common.PagingButton;
...
public class MenuController {
   ...
   */
  @GetMapping("/list")
  public String findMenuList(Model model, @PageableDefault(size=5) Pageable pageable) {
